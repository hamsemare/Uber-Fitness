...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.getEvents = function () {
        ...
        this.authService.getProfile().subscribe(function (profile) {
            ...
            _this.authService.getEvents().subscribe(function (data) {
    ...
    ], DashboardComponent.prototype, "ucCalendar", void 0);
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.addEvent = function (event) {
        ...
        return this.http.post('users/addEvent', event, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.getEvents = function () {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.get('users/events', { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
var ValidateService = /** @class */ (function () {
    ...
    ValidateService.prototype.validateDate = function (event) {
